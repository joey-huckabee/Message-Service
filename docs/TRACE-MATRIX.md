...
| L2-SWEEP-002 | L3-SWEEP-003, L3-SWEEP-017 | `tests/integration/persistence/test_run_repository.py::test_list_expired_inclusive_boundary`<br>`tests/unit/application/use_cases/test_sweeper.py::test_tick_classifies_run_at_exact_timeout_as_orphan` | Partially Implemented |
...
| L2-SWEEP-004 | L3-SWEEP-006 | `tests/integration/persistence/test_run_repository.py::test_list_expired_returns_runs_older_than_cutoff_in_active_states`<br>`tests/integration/persistence/test_run_repository.py::test_list_expired_uses_updated_at_not_created_at` | Partially Implemented |
...
| DEP | 3 | 9 | 18 | 1 | 18 |
| CICD | 7 | 15 | 17 | 1 | 17 |
| **Total** | **67** | **192** | **390** | **65** | **244** |

**Requirements verified by at least one test**: 309 of 582 (53.1%).
