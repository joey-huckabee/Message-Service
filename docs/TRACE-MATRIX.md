...
| L2-SWEEP-005 | L3-SWEEP-007 | `tests/unit/infrastructure/persistence/test_run_repository.py::test_list_expired_state_filter_includes_only_active_states` | Implemented |
...
| L2-SWEEP-010 | L3-SWEEP-008 | `tests/unit/application/use_cases/test_sweeper.py::test_backlog_drains_across_multiple_ticks`<br>`tests/unit/infrastructure/persistence/test_run_repository.py::test_list_expired_honors_limit_parameter` | Implemented |
